...
Dim nFile As Long
    ...
    TBackup.mFormData.nTop = Frm.Top
    TBackup.mFormData.nLeft = Frm.Left
...
Dim I As Integer
    ...
    Frm.Top = TBackup.mFormData.nTop
    Frm.Left = TBackup.mFormData.nLeft
